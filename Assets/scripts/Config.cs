...
public class Config
{
    ...
    public static controls player1 = controls.create_control(KeyCode.A,KeyCode.D);
    public static List<controls> playerControls = new List<controls> { player1, controls.create_control(KeyCode.LeftArrow, KeyCode.RightArrow), controls.create_control(KeyCode.B, KeyCode.N), controls.create_control(KeyCode.O, KeyCode.P) };
    ...
    // public Config(List<Array> players){
